...
proc init_gui { IPINST } {
  ...
  set_property tooltip {Width of all address busses} ${C_AXI_ADDR_WIDTH}
  set C_AXI_DATA_WIDTH [ipgui::add_param $IPINST -name "C_AXI_DATA_WIDTH" -parent ${Page_0}]
  set_property tooltip {Width of all data busses} ${C_AXI_DATA_WIDTH}
