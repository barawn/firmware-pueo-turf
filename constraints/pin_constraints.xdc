...
set_property PACKAGE_PIN E9 [get_ports GPS_RX]
...
####################################################################################
# Constraints from file : 'ddr_pin_constraints.xdc'
####################################################################################
...
set_property PACKAGE_PIN AW11 [get_ports {TXCLK_N[3]}]
set_property IOSTANDARD LVDS [get_ports {TXCLK_N[3]}]
set_property PACKAGE_PIN AW10 [get_ports {TXCLK_P[3]}]
set_property IOSTANDARD LVDS [get_ports {TXCLK_P[3]}]
